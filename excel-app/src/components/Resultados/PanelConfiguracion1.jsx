              ...
              <div style={{ background: "var(--bg-card)", padding: "15px", borderRadius: "8px", border: "1px solid var(--border-color)", display: "flex", flexDirection: "column", gap: "15px" }}>
                ...
                <div style={{ padding: "10px", backgroundColor: "rgba(0,0,0,0.05)", borderRadius: "6px", border: "1px solid var(--border-color)" }}>
                  ...
                  <div style={{ display: "flex", gap: "10px" }}>
                    <button
                      onClick={() => setTipoDatos("individuales")}
                      style={{
                        flex: 1, padding: "8px", border: "1px solid var(--border-color)",
                        backgroundColor: tipoDatos === "individuales" ? "var(--primary-color)" : "transparent",
                        color: tipoDatos === "individuales" ? "white" : "inherit",
                        borderRadius: "4px", cursor: "pointer",
                        fontWeight: tipoDatos === "individuales" ? "bold" : "normal",
                        transition: "all 0.2s"
                      }}
                    >
                      Individuales (Brutos)
                    ...
                    <button
                      onClick={() => setTipoDatos("agrupados")}
                      style={{
                        flex: 1, padding: "8px", border: "1px solid var(--border-color)",
                        backgroundColor: tipoDatos === "agrupados" ? "var(--primary-color)" : "transparent",
                        color: tipoDatos === "agrupados" ? "white" : "inherit",
                        borderRadius: "4px", cursor: "pointer",
                        fontWeight: tipoDatos === "agrupados" ? "bold" : "normal",
                        transition: "all 0.2s"
                      }}
                    >
                      Agrupados (Conjuntos)
