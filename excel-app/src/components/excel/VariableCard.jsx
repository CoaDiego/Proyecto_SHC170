        ...
        <div className="variable-card" style={{
            ...
            <div className='container_muestras' style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
                ...
                {v.tipo && (
                    <span style={{
                        fontSize: '9px',
                        backgroundColor: v.tipo.includes('Mixta') ? '#fee2e2' : (v.tipo.includes('Cualitativa') ? '#dbeafe' : '#dcfce7'),
                        color: v.tipo.includes('Mixta') ? '#b91c1c' : (v.tipo.includes('Cualitativa') ? '#1e40af' : '#15803d'),
                        padding: '3px 8px',
                        borderRadius: '5px',
                        fontWeight: 'bold',
