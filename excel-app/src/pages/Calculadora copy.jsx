...
import { DataGrid } from "react-data-grid"; // 👈 SOLO IMPORTA DataGrid
...
// ==========================================================
// 🛠️ SOLUCIÓN: DEFINIMOS EL EDITOR MANUALMENTE AQUÍ
// ==========================================================
...
export default function Calculadora() {
  ...
  const formatearCelda = (valor) => {
    /* ... tu función formatearCelda igual ... */
  ...
  // ==========================================================
  // ⚙️ CONFIGURACIÓN REACT DATA GRID
  // ==========================================================
  const rdgColumns = [];
  ...
  if (selectedColumn) {
      rdgColumns.push({
          ...
          renderEditCell: textEditor,  // 👈 USAMOS LA FUNCIÓN MANUAL (renderEditCell)
          editable: true,
          resizable: true,
          width: '50%',
  ...
  if (calculo === "distribucion_bivariada" && selectedColumnY) {
      rdgColumns.push({
          ...
          renderEditCell: textEditor, // 👈 USAMOS LA FUNCIÓN MANUAL
          editable: true,
          resizable: true,
          width: '50%',
  ...
  return (
    <div className="calculadora-layout">
        ...
        <div className="panel-controles-excel" style={{ marginTop: '20px', padding: '15px', border: '1px solid var(--border-color)', borderRadius: '8px', background: 'var(--bg-card)' }}>
            ...
            {columns.length > 0 ? (
                <>
                    ...
                    {/* ... (RESTO DE TU CÓDIGO: INTERVALOS Y BOTONES) ... */}
      ...
      {/* ... (DERECHA: RESULTADOS - COPIA TU CÓDIGO DE TABLAS Y GRÁFICOS AQUÍ) ... */}
